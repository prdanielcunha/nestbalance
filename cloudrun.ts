...
app.post('/api/member/intelligence-preferences', updateIntelligencePreferences);
app.post('/api/planning/scenarios/list', listPlanningScenarios);
app.post('/api/planning/scenarios/save', savePlanningScenario);
