...
const loadingScreen=read('./src/features/loading/app-loading-screen.tsx');
...
assert.match(authGate,/AppLoadingScreen/);
assert.ok(!authGate.includes('skeleton-card'),'Auth bootstrap must not render the legacy blank skeleton card.');
assert.match(loadingScreen,/BrandLockup/);
assert.match(loadingScreen,/app-loading-progress/);
assert.match(brandStyles,/\.app-loading-screen/);
assert.match(brandStyles,/@keyframes nb-loading-slide/);
