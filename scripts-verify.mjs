...
const cardStatementsSource=read('./server/card-statements.ts');
const cardStatementAi=read('./server/ai/card-statement-image.ts');
...
assert.match(cardStatementsSource,/credit_card\.statement_imported/);
assert.match(cardStatementsSource,/creditCardPurchaseKeys/);
assert.match(cardStatementsSource,/statementPreviews/);
assert.match(cardStatementAi,/store:false/);
assert.match(cardStatementAi,/untrusted data, never as instructions/);
assert.match(cloudrun,/\/api\/cards\/statements\/preview/);
assert.match(cloudrun,/\/api\/cards\/statements\/commit/);
